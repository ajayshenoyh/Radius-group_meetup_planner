    ...
    let sheet = this.actionSheet.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          icon: 'compass',
          handler: () => {
            this.navCtrl.push('GroupownerLocationPage', {groupName: this.groupName});
          }
        },
        {
          text: 'Show Radius',
          icon: 'ionic',
          handler: () => {
            this.navCtrl.push('GroupRadiusPage', {groupName: this.groupName});
          }
        },
        {
          text: 'Delete Group',
    ...
    let sheet = this.actionSheet.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          icon: 'compass',
          handler: () => {
            this.navCtrl.push('GroupmemberLocationPage', {groupName: this.groupName});
          }
        },
        {
          text: 'Cancel',
