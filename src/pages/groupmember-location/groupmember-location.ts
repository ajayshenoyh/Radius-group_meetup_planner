...
/**
 * Generated class for the GroupmemberLocationPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-groupmember-location',
  templateUrl: 'groupmember-location.html',
})
export class GroupmemberLocationPage {
        ...
        buttons: [
          ...
          },
          {
            ...
            handler: data => {
              ...
              this.groupservice.addmemberlocation(lastLocation).then(() => {
    ...
    this.geolocation.getCurrentPosition(locationOptions).then(
      (position) => {
        this.loading.dismiss().then(() => {
          ...
          this.map.setOptions(options);
          this.addMarker(myPos, "Your Location!");
          ...
          let alert = this.alertCtrl.create({
            ...
            buttons: [
              ...
              },
              {
                text: 'Save',
                handler: data => {
                  let lastLocation = { lat: position.coords.latitude, lng:position.coords.longitude };
                  console.log(lastLocation);
                  this.groupservice.addmemberlocation(lastLocation).then(() => {
                    this.showToast('Location saved');
                  });
